...
axios.defaults.baseURL = 'http://localhost/admin-raj/';
  ...
  methods: {
    async fetchCategories() {
      try {
        ...
        const response = await axios.get('http://localhost/admin-raj/database/controller/pos_categories.php');
    ...
    async saveCategory() {
      const url = 'http://localhost/admin-raj/database/controller/pos_categories.php';
      ...
      try {
        ...
        if (response.ok && data.success) {
          ...
          if (!this.isEdit) {
            // Navigate to Home_Page only if adding a new category (not editing)
            this.$router.push('/home'); // Adjust the path if necessary
          }
        } else {
