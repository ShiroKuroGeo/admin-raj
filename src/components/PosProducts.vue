...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        const [productsResponse, categoriesResponse] = await Promise.all([
          axios.get('http://localhost/admin-raj/database/controller/pos_product.php'),
          axios.get('http://localhost/admin-raj/database/controller/pos_categories.php')
        ]);
    ...
    async saveProduct() {
      ...
      try {
        const response = await axios.post('http://localhost/admin-raj/database/controller/pos_product.php', formData, {
          headers: {
    ...
    async deleteProduct() {
      ...
      try {
        const response = await axios.post('http://localhost/admin-raj/database/controller/pos_product.php', {
          action: 'delete',
