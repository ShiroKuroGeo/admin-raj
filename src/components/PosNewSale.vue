...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get("http://localhost/admin-raj/database/controller/posnewsale.php");
    ...
    const confirmOrder = async () => {
      ...
      try {
        ...
        const response = await axios.post('http://localhost/admin-raj/database/controller/posnewsale.php', orderData);
        console.log('Response from backend:', response.data);
