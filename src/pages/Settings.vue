...
export default {
  ...
  methods: {
    async fetchProfile() {
      try {
        const response = await axios.get('http://localhost/admin-raj/database/controller/profile.php');
    ...
    async saveProfile() {
      try {
        ...
        const response = await axios.post('http://localhost/admin-raj/database/api/update-profile.php', formData, {
          headers: {
